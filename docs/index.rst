.. manifold-sdk-js documentation master file, created by
   sphinx-quickstart on Tue Nov 29 10:25:33 2016.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

******************
What is manifold-sdk-js
******************

The manifold-sdk-js library aims to be a complete and compact library for interacting with the Maxonrow blockchain and its ecosystem.
