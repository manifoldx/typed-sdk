...
describe("Suite : Object", function () {
  ...
  it("checkFormat - should catch missing value", function () {
    ...
    try {
      ...
      expect(
        'missing object key b (key="b", object={"a":"hello"}, version=' +
          version +
          ")"
      ).to.eq(error.message);
    }
  ...
  it("checkFormat - should cater optional value", function () {
    {
      ...
      object = checkFormat(
        { a: checkString, b: allowNull(checkString) },
        object
      );
      object = checkFormat(
        { a: checkString, b: allowNullOrEmpty(checkString) },
        object
      );
  ...
  it("checkFormat - should catch invalid data type", function () {
    ...
    try {
      checkFormat(
        { a: checkString, b: expectTypeOf(checkString, "string") },
        object
      );
      errors.throwError("SHOULD_NOT_REACH_HERE", "", {});
    } catch (error) {
      ...
      expect(
        'invalid format object key b: expected type string, but number (value=123, key="b", object={"a":"hello","b":123}, version=' +
          version +
          ")"
      ).to.eq(error.message);
    }
  ...
  it("checkFormat - should cater optional value for data type check", function () {
    {
      ...
      object = checkFormat(
        { a: notAllowNullOrEmpty(expectTypeOf(checkString, "string")) },
        object
      );
      object = checkFormat(
        { a: checkString, b: allowNull(expectTypeOf(checkString, "string")) },
        object
      );
      object = checkFormat(
        {
          a: checkString,
          b: allowNullOrEmpty(expectTypeOf(checkString, "string")),
        },
        object
      );
    ...
    }
    {
      ...
      object = checkFormat(
        {
          a: notAllowNullOrEmpty(expectTypeOf(checkString, "string")),
          b: notAllowNullOrEmpty(expectTypeOf(checkString, "string")),
        },
        object
      );
      object = checkFormat(
  ...
  it("checkFormat - should catch invalid number", function () {
    {
      ...
      try {
        ...
        expect(errors.INVALID_FORMAT).to.eq(error.code);
        expect(
          'invalid format object key b: invalid BigNumber string value (value="abc", key="b", object={"a":123,"b":"abc"}, version=' +
            version +
            ")"
        ).to.eq(error.message);
      }
  ...
  it("checkFormat - should catch invalid string", function () {
    ...
    try {
      ...
      expect(errors.INVALID_FORMAT).to.eq(error.code);
      expect(
        'invalid format object key b: invalid string (value=123, key="b", object={"a":"hello","b":123}, version=' +
          version +
          ")"
      ).to.eq(error.message);
    }
  ...
  it("checkFormat - should catch invalid BigNumber", function () {
    ...
    try {
      ...
      expect(errors.INVALID_FORMAT).to.eq(error.code);
      expect(
        'invalid format object key b: invalid BigNumber string value (value="abc", key="b", object={"a":"123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123123","b":"abc"}, version=' +
          version +
          ")"
      ).to.eq(error.message);
    }
  ...
  it("checkFormat - should catch invalid boolean", function () {
    ...
    try {
      ...
      expect(errors.INVALID_FORMAT).to.eq(error.code);
      expect(
        "invalid format object key b: invalid boolean - " +
          object.b +
          ' (value=123, key="b", object={"a":true,"b":123}, version=' +
          version +
          ")"
      ).to.eq(error.message);
    }
  ...
  it("checkFormat - should catch invalid hex string", function () {
    ...
    try {
      ...
      expect(errors.INVALID_FORMAT).to.eq(error.code);
      expect(
        "invalid format object key b: invalid hex - " +
          object.b +
          ' (value="0xXYZ", key="b", object={"a":"0x123","b":"0xXYZ"}, version=' +
          version +
          ")"
      ).to.eq(error.message);
    }
