...
export function iterate(
  obj,
  modifier?: (key: string, value: any, type: string) => any
) {
  if (obj && "object" == typeof obj) {
    ...
    Object.keys(obj).forEach(function (key) {
      ...
      } else if (null === data) modified[key] = data;
      else {
      }
    });
    return modified;
...
export function allowNullOrEmpty(
  check: CheckFormatFunc,
  nullValue?: any
): CheckFormatFunc {
  return function (value: any) {
...
export function checkHex(string: string) {
  if (typeof string === "string") {
    ...
    if (isHexString(string)) return string;
  }
