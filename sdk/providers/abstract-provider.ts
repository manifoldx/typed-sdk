...
export abstract class Provider implements OnceBlockable {
  ...
  abstract getTransactionRequest(
    route: string,
  ...
  abstract getTransactionFeeSetting(
    transactionType: string,
    overrides?: any
  ...
  abstract getTokenState(
    symbol: string | Promise<string>,
    blockTag?: BlockTag | Promise<BlockTag>
  ): Promise<TokenState>;
  abstract getTokenList(
    blockTag?: BlockTag | Promise<BlockTag>
  ): Promise<TokenList>;
  abstract getTokenAccountState(
    symbol: string | Promise<string>,
    address: string | Promise<string>,
    blockTag?: BlockTag | Promise<BlockTag>
  ): Promise<TokenAccountState>;

  abstract getNFTokenState(
    symbol: string | Promise<string>,
    blockTag?: BlockTag | Promise<BlockTag>
  ): Promise<NFTokenState>;
  abstract getNFTokenItemState(
    symbol: string | Promise<string>,
    itemID: string,
    blockTag?: BlockTag | Promise<BlockTag>
  ...
  abstract checkTransactionReceipt(
  ...
  abstract isWhitelisted(
    addressOrName: string | Promise<string>,
    blockTag?: BlockTag | Promise<BlockTag>
  ): Promise<boolean>;
  abstract getKycAddress(
    addressOrName: string | Promise<string>,
    blockTag?: BlockTag | Promise<BlockTag>
  ): Promise<string>;
