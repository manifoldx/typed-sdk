...
export const DynamicSupplyFungibleTokenFlag =
  TokenStateFlags.fungible + TokenStateFlags.mint + TokenStateFlags.burn;
export const FixedSupplyFungibleTokenFlag = TokenStateFlags.fungible;
export const FixedSupplyBurnableFungibleTokenFlag =
  TokenStateFlags.fungible + TokenStateFlags.burn;
...
function checkFungibleTokenAccountStatus(
  data: any
): FungibleTokenAccountStatusTransaction {
  return checkFormat(
    {
...
export class FungibleToken {
  ...
  get isMintable() {
    ...
    if (!(TokenStateFlags.mint & this._state.flags)) {
      errors.throwError("not mintable", errors.NOT_ALLOWED, {
        action: "mintable",
        state: this._state,
      });
    }
  ...
  get isBurnable() {
    ...
    if (!(TokenStateFlags.burn & this._state.flags)) {
      errors.throwError("not burnable", errors.NOT_ALLOWED, {
        action: "burnable",
        state: this._state,
      });
    }
  ...
  refresh(overrides?: any) {
    ...
    return this.getState(null, { ...overrides, queryOnly: true }).then(
      (state) => {
        ...
        return this.getAccountState(null, {
          ...overrides,
          queryOnly: true,
        }).then((accountState) => {
  ...
  getAccountState(blockTag?: BlockTag, overrides?: any) {
    if (!this.signer) {
      errors.throwError(
        "query fungible token account require signer",
    ...
    return resolveProperties({ signerAddress: this.signer.getAddress() }).then(
      ({ signerAddress }) => {
        if (!signerAddress) {
          errors.throwError(
            "query fungible token account require signer address",
        ...
        return this.provider
          .getTokenAccountState(this.symbol, signerAddress, blockTag)
          .then((result) => {
            if (!(overrides && overrides.queryOnly)) {
  ...
  transfer(
    ...
    return this.getTransferTransactionRequest(
      toAddressOrName,
      value,
      overrides
    ).then((tx) => {
        ...
        return this.signer.provider
          ...
          .then((receipt) => {
            ...
            throw this.signer.provider.checkTransactionReceipt(
              ...
              "transfer fungible token failed",
              {
  ...
  getTransferTransactionRequest(
    ...
    if (!this.signer) {
      errors.throwError(
        "transfer fungible token require signer",
        errors.NOT_INITIALIZED,
        { arg: "signer" }
      );
    }
    ...
    return resolveProperties({
      ...
      if (!signerAddress) {
        return errors.throwError(
          "transfer fungible token require signer address",
          errors.MISSING_ARGUMENT,
          { arg: "signerAddress" }
        );
      }
  ...
  getMintTransactionRequest(
    ...
    if (!this.signer) {
      errors.throwError(
        "mint fungible token require signer",
        errors.NOT_INITIALIZED,
        { arg: "signer" }
      );
    }
  ...
  getBurnTransactionRequest(
    value: BigNumberish,
    overrides?: any
  ): Promise<TransactionRequest> {
    if (!this.signer) {
      errors.throwError(
        "burn fungible token require signer",
        errors.NOT_INITIALIZED,
        { arg: "signer" }
      );
    }
    ...
    return resolveProperties({ signerAddress: this.signer.getAddress() }).then(
      ({ signerAddress }) => {
        if (!signerAddress) {
          return errors.throwError(
            "burn fungible token require signer address",
            errors.MISSING_ARGUMENT,
            { arg: "signerAddress" }
          );
        }
        ...
        return this.signer.provider
          ...
          .then((receipt) => {
            ...
            throw this.signer.provider.checkTransactionReceipt(
              receipt,
              errors.CALL_EXCEPTION,
              "transfer fungible token ownership failed",
              {
  ...
  getTransferOwnershipTransactionRequest(
    ...
    if (!this.signer) {
      errors.throwError(
        "transfer fungible token ownership require signer",
        errors.NOT_INITIALIZED,
        { arg: "signer" }
      );
    }
    ...
    return resolveProperties({
      ...
      if (!signerAddress) {
        return errors.throwError(
          "transfer fungible token ownership require signer address",
          errors.MISSING_ARGUMENT,
      ...
      return this.provider.resolveName(addressOrName).then((toAddress) => {
        let tx = this.provider.getTransactionRequest(
          "token",
          "token-transferFungibleTokenOwnership",
          {
            symbol: this.symbol,
            from: signerAddress,
            to: toAddress,
        ...
        return this.signer.provider
          ...
          .then((receipt) => {
            ...
            throw this.signer.provider.checkTransactionReceipt(
              receipt,
              errors.CALL_EXCEPTION,
              "accept fungible token ownership failed",
              {
  ...
  getAcceptOwnershipTransactionRequest(
    ...
    return resolveProperties({ signerAddress: this.signer.getAddress() }).then(
      ({ signerAddress }) => {
        ...
        let tx = this.provider.getTransactionRequest(
          "token",
          "token-acceptFungibleTokenOwnership",
          {
            symbol: this.symbol,
            from: signerAddress,
            memo: overrides && overrides.memo ? overrides.memo : "",
  ...
  static create(
    ...
    signer: Signer,
    overrides?: any
  ): Promise<TransactionResponse | FungibleToken> {
    return this.getCreateTransactionRequest(properties, signer, overrides).then(
      (tx) => {
  ...
  static getCreateTransactionRequest(
    ...
    return resolveProperties({ address: signer.getAddress() }).then(
      ({ address }) => {
        if (!address) {
          errors.throwError(
            "create fungible token transaction require signer address",
            errors.MISSING_ARGUMENT,
            { required: "signer" }
          );
        }
        ...
        if (bigNumberify(fungibleToken.fee.value).lt(0)) {
          errors.throwError(
            "create fungible token transaction require non-negative application fee",
   ...
   * @param overrides options
   */
  static signFungibleTokenStatusTransaction(
    transaction: FungibleTokenStatusTransaction,
    signer: Signer,
    overrides?: any
  ) {
    if (!Signer.isSigner(signer)) {
      errors.throwError(
        "sign fungible token status transaction require signer",
        errors.MISSING_ARGUMENT,
        { arg: "signer" }
      );
    }
   ...
   * @param overrides options
   */
  static signFungibleTokenAccountStatusTransaction(
    transaction: FungibleTokenAccountStatusTransaction,
    signer: Signer,
    overrides?: any
  ) {
    if (!Signer.isSigner(signer)) {
   ...
   * @param overrides options
   */
  static sendFungibleTokenStatusTransaction(
    transaction: FungibleTokenStatusTransaction,
    signer: Signer,
    overrides?: any
  ): Promise<TransactionResponse | TransactionReceipt> {
    return this.getFungibleTokenStatusTransactionRequest(
      transaction,
      signer,
      overrides
    ).then((tx) => {
        ...
        return signer.provider
          ...
          .then((receipt) => {
            ...
            throw signer.provider.checkTransactionReceipt(
              receipt,
              errors.CALL_EXCEPTION,
              "set fungible token status failed",
              {
  ...
  static getFungibleTokenStatusTransactionRequest(
    transaction: FungibleTokenStatusTransaction,
    signer: Signer,
    overrides?: any
  ): Promise<TransactionRequest> {
    if (!Signer.isSigner(signer)) {
      errors.throwError(
        "send fungible token status transaction require signer",
        errors.MISSING_ARGUMENT,
        { arg: "signer" }
      );
    }
   ...
   * @param overrides options
   */
  static sendFungibleTokenAccountStatusTransaction(
    transaction: FungibleTokenAccountStatusTransaction,
    signer: Signer,
    overrides?: any
  ): Promise<TransactionResponse | TransactionReceipt> {
    return this.getFungibleTokenAccountStatusTransactionRequest(
      transaction,
      signer,
      overrides
    ).then((tx) => {
        ...
        return signer.provider
          ...
          .then((receipt) => {
            ...
            throw signer.provider.checkTransactionReceipt(
              receipt,
              errors.CALL_EXCEPTION,
              "set fungible token account status failed",
              {
  ...
  static getFungibleTokenAccountStatusTransactionRequest(
    transaction: FungibleTokenAccountStatusTransaction,
    signer: Signer,
    overrides?: any
  ): Promise<TransactionRequest> {
    ...
    return resolveProperties({ signerAddress: signer.getAddress() }).then(
      ({ signerAddress }) => {
        let tx = signer.provider.getTransactionRequest(
          "token",
          "token-setFungibleTokenAccountStatus",
          {
            payload: transaction.payload,
            signatures: transaction.signatures,
            owner: signerAddress,
   ...
   * @param overrides options
   */
  static approveFungibleTokenOwnership(
    symbol: string,
    signer: Signer,
    overrides?: any
  ) {
   ...
   * @param overrides options
   */
  static rejectFungibleTokenOwnership(
    symbol: string,
    signer: Signer,
    overrides?: any
  ) {
   ...
   * @param overrides options
   */
  static freezeFungibleTokenAccount(
    symbol: string,
    to: string,
    signer: Signer,
    overrides?: any
  ) {
    return setFungibleTokenAccountStatus(
      symbol,
      to,
      "FREEZE_ACCOUNT",
      signer,
   ...
   * @param overrides options
   */
  static unfreezeFungibleTokenAccount(
    symbol: string,
    to: string,
    signer: Signer,
    overrides?: any
...
function setFungibleTokenStatus(
  symbol: string,
  status: string,
  signer: Signer,
  overrides?: any
  ...
  if (!symbol) {
    errors.throwError(
      "set fungible token status transaction require symbol",
      errors.MISSING_ARGUMENT,
      { arg: "symbol" }
    );
  }
    ...
    case "APPROVE":
      if (overrides) {
        if (isUndefinedOrNull(overrides.burnable)) {
          errors.throwError(
            "fungible token burnable setting is missing",
            errors.MISSING_ARGUMENT,
            { arg: "burnable" }
          );
        }
      ...
      if (isUndefinedOrNullOrEmpty(tokenFees)) {
        errors.throwError(
          "fungible token fees are missing",
          errors.MISSING_ARGUMENT,
          { arg: "tokenFees" }
        );
      }
...
function setFungibleTokenAccountStatus(
  symbol: string,
  to: string,
  status: string,
  signer: Signer,
  ...
  if (!Signer.isSigner(signer)) {
    errors.throwError(
      "set fungible token account status transaction require signer",
      errors.MISSING_ARGUMENT,
      { arg: "signer" }
    );
  }
  if (!symbol) {
    errors.throwError(
      "set fungible token account status transaction require symbol",
      errors.MISSING_ARGUMENT,
      { arg: "symbol" }
    );
  }
  if (!to) {
    errors.throwError(
      "set fungible token account status transaction require target account",
      errors.MISSING_ARGUMENT,
      { arg: "to" }
    );
  }
  ...
  switch (status) {
    ...
    case "UNFREEZE_ACCOUNT":
      try {
        ...
        errors.throwError(
          "fungible token target account is not valid",
    ...
    default:
      errors.throwError(
        "invalid fungible token account status",
        errors.UNEXPECTED_ARGUMENT,
        { arg: "status", value: status }
      );
  }
  ...
  return resolveProperties({
    ...
    return resolveProperties({ nonce: nonce }).then(({ nonce }) => {
      ...
      return signer
        .signMessage(JSON.stringify(transaction.payload.tokenAccount), true)
        .then((signature) => {
          transaction.payload.signature = base64Encode(signature);
          return transaction;
        });
