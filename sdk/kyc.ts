...
export class Kyc {
  ...
  constructor(signerOrProvider: Signer | Provider) {
    ...
    if (Signer.isSigner(signerOrProvider)) {
      ...
      return errors.throwError(
        ...
        { arg: "signerOrProvider", value: signerOrProvider }
      );
    }
  }
  ...
  whitelist(
    ...
    return this.getWhitelistTransactionRequest(transaction, overrides).then(
      (tx) => {
  ...
  getWhitelistTransactionRequest(
    transaction: KycTransaction,
    overrides?: any
  ): Promise<TransactionRequest> {
    if (!this.signer) {
      errors.throwError("kyc require signer", errors.NOT_INITIALIZED, {
        arg: "signer",
      });
    }
    if (!this.provider) {
      errors.throwError("missing provider", errors.NOT_INITIALIZED, {
        arg: "provider",
      });
    }
  ...
  getKycAddress(keyComponent: KycKeyComponent) {
    if (!keyComponent) {
      errors.throwError("missing key component", errors.MISSING_ARGUMENT, {
        arg: "keyComponent",
      });
    }

    checkProperties(keyComponent, {
      country: true,
      idType: true,
      id: true,
      idExpiry: true,
   ...
   */
  sign(
    keyComponentOrAddress: KycKeyComponent | string,
    overrides?: any
  ): Promise<KycData> {
    if (!this.signer) {
      errors.throwError("kyc require signer", errors.NOT_INITIALIZED, {
    ...
    if (!this.provider) {
      errors.throwError("kyc require provider", errors.NOT_INITIALIZED, {
        arg: "provider",
      });
    }
    ...
    return resolveProperties({
      ...
      return resolveProperties({ nonce: nonce }).then(({ nonce }) => {
        ...
        return this.signer
          .signMessage(JSON.stringify(kycData.kyc), true)
          .then((signature) => {
  ...
  signTransaction(
    transaction: KycTransaction,
    overrides?: any
  ): Promise<KycTransaction> {
    if (!this.signer) {
      errors.throwError("sign kyc require signer", errors.NOT_INITIALIZED, {
        arg: "signer",
      });
    }
    checkProperties(transaction, { payload: true, signatures: true });
  ...
  static revoke(address: string, signer: Signer, overrides?: any) {
    if (!Signer.isSigner(signer)) {
      errors.throwError(
        "create revocation transaction require signer",
    ...
    if (!signer.provider) {
      errors.throwError(
        "create revocation transaction require provider",
        errors.MISSING_ARGUMENT,
        { arg: "signer" }
      );
    }
    if (!address) {
      errors.throwError(
        "create revocation transaction require address",
        errors.MISSING_ARGUMENT,
        { arg: "address" }
      );
    }
    ...
    return resolveProperties({
      ...
      return resolveProperties({ nonce: nonce }).then(({ nonce }) => {
        ...
        return signer
          .signMessage(JSON.stringify(transaction.payload.kyc), true)
          .then((signature) => {
   ...
   * @param overrides options
   */
  static signRevokeTransaction(
    transaction: KycRevokeTransaction,
    signer: Signer,
    overrides?: any
  ) {
    if (!Signer.isSigner(signer)) {
      errors.throwError(
        "sign revocation transaction require signer",
        errors.MISSING_ARGUMENT,
        { arg: "signer" }
      );
    }
   ...
   * @param overrides options
   */
  static sendRevokeTransaction(
    transaction: KycRevokeTransaction,
    signer: Signer,
    overrides?: any
  ): Promise<TransactionResponse | TransactionReceipt> {
    return this.getRevokeTransactionRequest(
      transaction,
      signer,
      overrides
    ).then((tx) => {
  ...
  static getRevokeTransactionRequest(
    transaction: KycRevokeTransaction,
    signer: Signer,
    overrides?: any
  ): Promise<TransactionRequest> {
    if (!Signer.isSigner(signer)) {
      errors.throwError(
        "send revocation transaction require signer",
        errors.MISSING_ARGUMENT,
        { arg: "signer" }
      );
    }
    if (!signer.provider) {
      errors.throwError(
        "send revocation transaction require provider",
        errors.MISSING_ARGUMENT,
        { arg: "provider" }
      );
    }
  ...
  static bind(
    ...
    return this.getBindTransactionRequest(
      addressOrName,
      kycAddress,
      signer,
      overrides
  ...
  static getBindTransactionRequest(
    addressOrName: string | Promise<string>,
    kycAddress: string,
    signer: Signer,
    overrides?: any
    ...
    if (!Signer.isSigner(signer)) {
      errors.throwError(
        "kyc bind transaction require signer",
        errors.MISSING_ARGUMENT,
        { arg: "signer" }
      );
    }
    if (!signer.provider) {
      errors.throwError(
        "kyc bind transaction require provider",
        errors.MISSING_ARGUMENT,
        { arg: "provider" }
      );
    }
  ...
  static unbind(
    ...
    return this.getUnbindTransactionRequest(
      addressOrName,
      kycAddress,
      signer,
      overrides
  ...
  static getUnbindTransactionRequest(
    addressOrName: string | Promise<string>,
    kycAddress: string,
    signer: Signer,
    overrides?: any
    ...
    if (!Signer.isSigner(signer)) {
      errors.throwError(
        "kyc unbind transaction require signer",
        errors.MISSING_ARGUMENT,
        { arg: "signer" }
      );
    }
    if (!signer.provider) {
      errors.throwError(
        "kyc unbind transaction require provider",
        errors.MISSING_ARGUMENT,
        { arg: "provider" }
      );
    }
